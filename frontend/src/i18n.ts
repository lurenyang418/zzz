...
const messages = {
  zh: {
    ...
    'output.folderSmartHelp': '按智能目录规则写入挂载目录。',
    'output.zipHelp': '在挂载目录中生成 ZIP 文件。',
    'output.structure': '目录结构',
    'output.structureOriginal': '原始结构',
    'output.structureSmart': '智能结构',
    'output.structureOriginalHelp': '保留选中文件的原始目录层级。',
    'output.structureSmartHelp': '移除选中内容共同的父目录，同时保留必要的分支结构。',
  ...
  en: {
    ...
    'output.hostUnavailable': 'Host export is unavailable: DOWNLOAD_ROOT is missing or the mounted directory is not writable.',
    ...
    'output.folderSmartHelp': 'Write files to the mounted directory using smart folder rules.',
    'output.zipHelp': 'Generate a ZIP file inside the mounted directory.',
    'output.structure': 'Folder structure',
    'output.structureOriginal': 'Original',
    'output.structureSmart': 'Smart',
    'output.structureOriginalHelp': 'Keep the original directory hierarchy of the selected files.',
    'output.structureSmartHelp': 'Remove shared parent directories while preserving the necessary branch structure.',
